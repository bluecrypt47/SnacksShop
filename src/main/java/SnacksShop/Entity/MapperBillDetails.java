 ...
 * 
 * @Override public BillDetails mapRow(ResultSet rs, int rowNum) throws
 * SQLException { BillDetails billDetails = new BillDetails();
 * 
 * billDetails.setId(rs.getInt("id"));
 * billDetails.setIdProduct(rs.getString("idProduct"));
